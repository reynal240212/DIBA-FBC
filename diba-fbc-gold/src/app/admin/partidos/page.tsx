...
import { Calendar, Dumbbell, Trophy, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-16 max-w-[1200px] mx-auto min-h-[60vh] flex flex-col justify-center">
      ...
      <div className="space-y-6">
        ...
        <h1 className="text-6xl lg:text-8xl font-black text-white italic uppercase tracking-tighter leading-[0.85] flex flex-col">
           <span>Partidos &</span>
           <span className="text-yellow-500">Eventos</span>
        </h1>
      </div>
      ...
      >
        ...
        <div className="absolute top-0 right-0 p-12 opacity-[0.03] group-hover:scale-110 transition-transform duration-700 pointer-events-none">
           <Calendar size={320} className="text-yellow-500" />
        </div>
        ...
        <div className="relative z-10 space-y-10 max-w-2xl">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl lg:text-4xl font-black italic uppercase tracking-tighter text-white">
              GESTOR DE ENCUENTROS Y <span className="text-yellow-500">FIXTURES</span>
            </h2>
            <p className="text-slate-400 text-sm leading-relaxed font-medium">
              Estamos integrando el panel administrativo para la creación de partidos de torneos oficiales, programación de entrenamientos y sincronización en tiempo real. Esta sección permitirá registrar rivales, definir uniformes oficiales, fijar canchas y costos de arbitraje/transporte de forma centralizada.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            {[
              { title: "Programación de Partidos", desc: "Configura hora, rival, uniforme de juego, valor y observaciones." },
              { title: "Gestión de Entrenamientos", desc: "Control de fechas, horas y sedes oficiales de preparación física." },
            ].map((f, i) => (
