...
import { Bell, Send, Wifi, ArrowRight } from 'lucide-react';
    ...
    <div className="space-y-16 max-w-[1200px] mx-auto min-h-[60vh] flex flex-col justify-center">
      ...
      <div className="space-y-6">
        ...
        <h1 className="text-6xl lg:text-8xl font-black text-white italic uppercase tracking-tighter leading-[0.85] flex flex-col">
           ...
           <span className="text-yellow-500">Push</span>
        </h1>
      </div>
      ...
      >
        ...
        <div className="absolute top-0 right-0 p-12 opacity-[0.03] group-hover:scale-110 transition-transform duration-700 pointer-events-none">
           <Bell size={320} className="text-yellow-500" />
        </div>
        ...
        <div className="relative z-10 space-y-10 max-w-2xl">
          ...
          <div className="space-y-6">
            <h2 className="text-3xl lg:text-4xl font-black italic uppercase tracking-tighter text-white">
              DIFUSIÓN MASIVA Y <span className="text-yellow-500">WEB PUSH</span>
            </h2>
            <p className="text-slate-400 text-sm leading-relaxed font-medium">
              Estamos integrando el panel web para estructurar y emitir notificaciones push directamente a los dispositivos móviles y navegadores de todos los suscritos. Podrás anunciar cambios de horario, tarifas de partidos y noticias de urgencia vinculadas al club.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
            {[
              { title: "Broadcast en Tiempo Real", desc: "Redacta el título, mensaje y enlace de destino en un solo clic." },
              { title: "Segmentación Avanzada", desc: "Envía comunicados específicos para categorías individuales." },
            ].map((f, i) => (
